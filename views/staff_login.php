    ...
    <div class="flex flex-col lg:flex-row flex-between items-center h-screen">
        <?php if (isset($accounts) && count($accounts)) : ?>
            <div class="mx-auto flex w-full max-w-sm flex-col gap-6 mb-3 lg:mb-0">
                <h1 class="text-3xl font-semibold text-center">Choose Logged Account</h1>
                <?php foreach ($accounts as $account) : ?>
                    <div class="alert">
                        ...
                        <div class="avatar avatar-square rounded overflow-hidden">
                            <img src="../controllers/images/users/<?= $account->image ?>" alt="avatar" style="border-radius: 0;" />
                        </div>
        ...
        <div class="mx-auto flex w-full max-w-sm flex-col gap-6">
            <div class="flex flex-col items-center">
                <h1 class="text-3xl font-semibold">Sign In Staff Account</h1>
                <p class="text-sm">Sign in to access your account</p>
            </div>
            <form class="form-group" action="../controllers/staff_login.php" method="post">
                ...
                <div class="form-field">
                    <div class="form-control justify-center">
                        <a href="customer_login.php" class="link link-underline-hover link-primary text-sm">Are you a customer of Gundam Shop? Sign in.</a>
                        <!-- <a href="staff_register.php" class="link link-underline-hover link-primary text-sm">Don't have an account yet? Sign up.</a> -->
                    </div>
                </div>
            </form>
        </div>
